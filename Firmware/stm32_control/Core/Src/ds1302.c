...
/* Pines reasignados para Grupo-1: los originales PA5/PA7 estaban en SPI1 (MEMS).
 * CLK=PD8, DAT/IO=PD9. RST se pasa por Ds1302Config_t desde main.c (PD10).
 * PD8 y PD10 se configuran como salida en gpio.c (MX_GPIO_Init); PD9 lo maneja
 * este driver (es bidireccional). */

 ...
 *
 * Pinout en Grupo-1 (reasignado desde PA5/PA7/PE3, que están en SPI1/MEMS):
 * CLK = PD8   (salida, configurada en gpio.c)
 * DAT = PD9   (bidireccional, la reconfigura el driver)
 * RST = PD10  (salida, configurada en gpio.c; se pasa por Ds1302Config_t)
 *
 * @author Lucas
 * @date 28/04/26
 */
